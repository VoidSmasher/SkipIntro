...
namespace SkipIntro
{
    ...
    public class SkipIntroTacInstanceData
    {
    ...
    /// </summary>
    public class SkipIntroTactical : ModTactical
    {
        /// <summary>
        ...
        public override void OnTacticalStart()
        {
            ...
            // SkipIntroMain main = (SkipIntroMain)Main;
        }
        /// <summary>
        ...
        {
            // SkipIntroTacInstanceData data = (SkipIntroTacInstanceData)instanceData;
        }
        /// <summary>
        ...
        {
            return new SkipIntroTacInstanceData() { ExampleData = 5 };
        }
        /// <summary>
