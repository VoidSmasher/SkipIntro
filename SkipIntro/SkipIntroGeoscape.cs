...
namespace SkipIntro
{
    ...
    public class SkipIntroGSInstanceData
    {
    ...
    /// </summary>
    public class SkipIntroGeoscape : ModGeoscape
    {
        /// <summary>
        ...
        {
            return new SkipIntroGSInstanceData() { ExampleData = 5 };
        }
        /// <summary>
        ...
        {
            // SkipIntroGSInstanceData data = (SkipIntroGSInstanceData)instanceData;
        }
